					...
					<div class="board">
						<div class="board-category">
							<div class="category-name">
								<svg class="icon align-top icon-sm"><use xlink:href="/templates/joomla-designitalia/svg/sprite.svg#it-pa"></use></svg>	
								<?php
									$db = JFactory::getDbo();
									$id = $item->core_catid;
									...
									$dbslug = JFactory::getDbo();
									$id = $item->core_catid;
									$dbslug->setQuery("SELECT cat.alias FROM #__categories cat WHERE cat.id='$id'");
									...
									echo '<a href="index.php?option=com_content&view=category&layout=istituti&id='.$item->core_catid.'" title="'.$category.'">'.$category.'</a>';
						...
						<div class="board-readmore">
							<p class="readmore"><a class="" href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>"><?php echo JText::_('Leggi tutto...') ?></a></p>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
